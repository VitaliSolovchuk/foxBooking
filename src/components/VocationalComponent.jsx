...
const VocationalComponent = ({ lessonConfig, records, setRecords, setIsLoad, controller}) => {
  ...
  const [fetchGroups, isGroupsLoading, groupsErr] = useFetching(async () => {
    ...
    const groups = await controller.getGroups("ПФ")
...
export default VocationalComponent;
