...
function App({dealId, ALFA_API_KEY, BITRIX_AUTH}) {


  const [isLoad, setIsLoad] = useState(false);
  const [fetchingController, isLoadingController, errorController] = useFetching(async () => await Controller.build(dealId, BITRIX_AUTH, ALFA_API_KEY))
